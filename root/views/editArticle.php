...
<main>
    <div class="fadeDown_2" id="edit-form">
        ...
        <!-- 入力内容送信フォーム -->
        <form method="GET" name="editArticleForm" action="/edit/confirm">
            ...
            <div class="edit-title">
                ...
                <input id="edit-title" type="text" placeholder="【PHP】入力フォームの改良" />
            </div>
            ...
            <div class="edit-tag">
                ...
                <input id="edit-tag" type="text" placeholder="#PHP,#備忘録,#CSS" />
            </div>
            ...
            <div class="edit-content">
                ...
                <textarea id="edit-content" type="textarea" placeholder="ここに記事内容をMarkDown形式で記載"></textarea>
            </div>
